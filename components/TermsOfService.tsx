  ...
  return (
    <div className="pt-8 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="prose prose-stone prose-lg max-w-none font-body text-textSecondary leading-relaxed">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">1. Acceptance of Terms</h3>
        <p className="mb-8">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">2. Use of Service</h3>
        <p className="mb-4">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">4. User Content</h3>
        <p className="mb-8">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">5. Limitation of Liability</h3>
        <p className="mb-8">
