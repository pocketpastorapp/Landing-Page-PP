    ...
    return (
        <div className="min-h-screen bg-cream dark:bg-dark-bg pt-8 pb-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
            <div className="max-w-4xl mx-auto animate-fade-in">
                ...
                <h1 className="text-4xl md:text-5xl font-serif font-bold text-text dark:text-dark-text mb-8">Built for Believers, by Believers</h1>

                <div className="prose prose-stone prose-lg dark:prose-invert max-w-none font-body text-textSecondary dark:text-dark-textSecondary leading-relaxed mb-16">
                ...
                <div className="border-t border-primary/10 dark:border-white/5 pt-16">
                    <div className="text-center mb-16">
                        <h2 className="text-primary font-bold tracking-wider uppercase text-sm mb-3">What We Believe</h2>
                        <h3 className="text-3xl md:text-4xl font-serif font-bold text-text dark:text-dark-text mb-6">Our Foundation</h3>
                        <p className="text-xl text-textSecondary dark:text-dark-textSecondary max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-2xl flex items-center justify-center text-primary shrink-0">
                                <Compass size={24} />
                            </div>
                            <div>
                                <h4 className="text-xl font-bold text-text dark:text-dark-text font-serif mb-3">The Bible is Our Compass</h4>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-text dark:text-dark-text font-serif mb-3">Grace Alone, Faith Alone</h4>
                                <p className="text-textSecondary dark:text-dark-textSecondary leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-text dark:text-dark-text font-serif mb-3">An Active God</h4>
                                <p className="text-textSecondary dark:text-dark-textSecondary leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <h4 className="text-xl font-bold text-text dark:text-dark-text font-serif mb-3">Truth Delivered with Love</h4>
                                <p className="text-textSecondary dark:text-dark-textSecondary leading-relaxed">
