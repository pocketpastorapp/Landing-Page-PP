...
const CookiePolicy: React.FC<CookiePolicyProps> = ({ onBack }) => {
  return (
    <div className="pt-8 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto animate-fade-in">
      ...
      <h1 className="text-4xl md:text-5xl font-serif font-bold text-text mb-6">Cookie Policy</h1>
      ...
      <div className="prose prose-stone prose-lg max-w-none font-body text-textSecondary leading-relaxed">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">1. What are cookies?</h3>
        <p className="mb-8">
          Cookies are small data files that are placed on your computer or mobile device when you visit a website. Cookies are widely used by website owners in order to make their websites work, or to work more efficiently, as well as to provide reporting information.
        </p>

        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">2. How we use cookies</h3>
        <p className="mb-4">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">3. Managing cookies</h3>
        <p className="mb-8">
        ...
        <h3 className="text-2xl font-bold text-text mt-12 mb-6 font-serif border-b border-primary/10 pb-2">4. Updates to this policy</h3>
        <p className="mb-8">
