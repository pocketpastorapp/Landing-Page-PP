  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-dark-bg pt-8 pb-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto animate-fade-in">
        ...
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-text dark:text-dark-text mb-6">Privacy Policy</h1>
        <p className="text-textSecondary dark:text-dark-textSecondary text-lg mb-12">Last Updated: October 24, 2024</p>
        ...
        <div className="prose prose-stone prose-lg dark:prose-invert max-w-none font-body text-textSecondary dark:text-dark-textSecondary leading-relaxed">
          ...
          <h3 className="text-2xl font-bold text-text dark:text-dark-text mt-12 mb-6 font-serif border-b border-primary/10 dark:border-white/5 pb-2">1. Information Collection</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-text dark:text-dark-text mt-12 mb-6 font-serif border-b border-primary/10 dark:border-white/5 pb-2">2. How We Use Information</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-bold text-text dark:text-dark-text mt-12 mb-6 font-serif border-b border-primary/10 dark:border-white/5 pb-2">3. Data Protection</h3>
          <p className="mb-8">
          ...
          <h3 className="text-2xl font-bold text-text dark:text-dark-text mt-12 mb-6 font-serif border-b border-primary/10 dark:border-white/5 pb-2">4. Contact Us</h3>
          <p className="mb-4">
